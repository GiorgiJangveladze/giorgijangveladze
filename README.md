...
Worked on a popular browser-based multiplayer strategy game using **PHP, JavaScript and MySQL**. Developed boss raid event functionality and premium gameplay features.

### 📚 TextBookX / Equitable Access Platform  
Contributed to an educational technology platform supporting textbook and learning-resource access using **Laravel, React.js, Vue.js, Ruby, Rails and MySQL**.

### 🚗 Automotive Catalogue & Supplier Platforms  
Built and led development for automotive sales, catalogue and supplier management systems using **Laravel, React.js and MySQL**.

### 🏛️ Prosecutor's Office Internal System  
Worked on a complex internal system for physical-file digitalisation and search, using **PHP, Laravel, JavaScript and ElasticSearch**.

### 🤖 AI & LLM Workflows  
Exploring and building with **AI-assisted development, Claude Code, LLM integrations, ComfyUI, LoRA training and checkpoint-based AI models**.
...
- Building scalable backend systems with **Laravel and PHP**
- Designing clean APIs and reliable third-party integrations
- Creating maintainable full-stack applications with **React.js and Vue.js**
- Improving database performance and application scalability
- Leading teams, reviewing code and mentoring developers
- Combining modern software engineering with AI-driven development workflows
